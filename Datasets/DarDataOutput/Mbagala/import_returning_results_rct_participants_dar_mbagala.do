* import_returning_results_rct_participants_dar_mbagala.do
*
* 	Imports and aggregates "Returning results (RCT participants) - Mbagala" (ID: returning_results_rct_participants_dar_mbagala) data.
*
*	Inputs:  "./Returning results (RCT participants) - Mbagala.csv"
*	Outputs: "./Returning results (RCT participants) - Mbagala.dta"
*
...
local csvfile "./Returning results (RCT participants) - Mbagala.csv"
local dtafile "./Returning results (RCT participants) - Mbagala.dta"
local corrfile "./Returning results (RCT participants) - Mbagala_corrections.csv"
local note_fields1 ""
...
*
*   Corrections file path and filename:  ./Returning results (RCT participants) - Mbagala_corrections.csv
*
...
do "import_returning_results_rct_participants_dar_mbagala-consented-section8-dce_game.do"
