* import_returning_results_rct_participants_dar_temeke.do
*
* 	Imports and aggregates "Returning results (RCT participants) - Temeke" (ID: returning_results_rct_participants_dar_temeke) data.
*
*	Inputs:  "./Returning results (RCT participants) - Temeke.csv"
*	Outputs: "./Returning results (RCT participants) - Temeke.dta"
*
...
local csvfile "./Returning results (RCT participants) - Temeke.csv"
local dtafile "./Returning results (RCT participants) - Temeke.dta"
local corrfile "./Returning results (RCT participants) - Temeke_corrections.csv"
local note_fields1 ""
...
*
*   Corrections file path and filename:  ./Returning results (RCT participants) - Temeke_corrections.csv
*
...
do "import_returning_results_rct_participants_dar_temeke-consented-section8-dce_game.do"
